import { createConsultaService, getAllConsultaService, deleteConsultaService } from '../services/consulta-service.js';
...
const deleteConsulta = async (req, res) => {
  const response = await deleteConsultaService(req.body, res.user.userId, res.user.franchise);
...
export default wrapControllers({ createConsulta, deleteConsulta, getAllConsulta });